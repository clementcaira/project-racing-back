...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    horsepower: Schema.Attribute.String;
    lap_times: Schema.Attribute.Relation<'oneToMany', 'api::lap-time.lap-time'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiLapTimeLapTime extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::lap-time.lap-time': ApiLapTimeLapTime;
